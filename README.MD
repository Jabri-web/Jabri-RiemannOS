...
→ Run: `Zx_Planck_Epoch.ipynb` → Data: `Zx_Planck_Epochs.csv`
...
5. **Dataset**: `Hz_RiemannOS_0.001.csv` [2806 rows, z=0.001 to z=1100]
...
4. Golden ratio φ, number 12, and 1.2 emerge as phase transitions in Z(x)
5. 28 fundamental constants derived from ζ(s) zeros: G, Λ, α, H₀
